...
public class ValueAnimatorCompatImplEclairMr1 extends ValueAnimatorCompat.Impl {
  ...
  public float getAnimatedFloatValue() {
    return AnimationUtils.lerp(this.mFloatValues[0], this.mFloatValues[1], this
        .getAnimatedFraction());
  }
  ...
  private void update() {
    if (this.mIsRunning) {
      ...
      this.mAnimatedFraction = this.mInterpolator != null ? this.mInterpolator.getInterpolation
